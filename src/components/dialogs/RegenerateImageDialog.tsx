...
const RegenerateImageDialog: FC<RegenerateImageDialogProps> = ({ 
  ...
  // OpenAI image model fixed to gpt-image-1
  const openAIModel: 'gpt-image-1' = 'gpt-image-1';
      ...
      <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <DialogContent className="w-full max-w-xs sm:max-w-lg bg-card">
          ...
          <div className="grid gap-3 sm:gap-4 py-4">
            ...
            <div className="flex items-center justify-between space-x-2 pt-2">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="model-toggle" className="cursor-pointer">
                  {modelChoice === 'gemini' ? 'Gemini' : 'ChatGPT'}
                </Label>
              </div>
            ...
            {/* OpenAI model selection removed; fixed to gpt-image-1 */}
          </div>
